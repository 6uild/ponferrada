...
export const CREATE_KEYRING_ID_STEP_2 = "create-keyring-step2";
...
const ShowWordsForm = ({ mnemonic, onBack, onHintPassword }: Props): JSX.Element => {
  ...
  return (
    <NeumaPageLayout id={CREATE_KEYRING_ID_STEP_2} primaryTitle="Recovery" title="Words">
      <Typography variant="body1" inline>
        Your secret recovery words consists of 12 words that act as a tool to recover your keyring on any
        platform.
      </Typography>
      <Block marginTop={2} />
