...
import NewKeyringForm from "./components/NewKeyringForm";
...
storiesOf(`${sanesRoot}/Create Keyring`, module)
  .add("New Keyring page", () => (
    <Storybook>
      <NewKeyringForm onBack={action("back in history")} onCreateKeyring={action("next step")} />
    </Storybook>
  ))
