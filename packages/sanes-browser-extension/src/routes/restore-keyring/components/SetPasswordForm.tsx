...
export const SET_PASSWORD_STEP_RESTORE_KEYRING_ROUTE = `${RESTORE_KEYRING}2`;
...
const SetPasswordForm = ({ onSetPassword, onBack }: Props): JSX.Element => {
  ...
  return (
    <NeumaPageLayout id={SET_PASSWORD_STEP_RESTORE_KEYRING_ROUTE} primaryTitle="Restore" title="Keyring">
