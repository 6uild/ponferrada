...
import { DELETE_KEYRING_ROUTE, KEYRING_STATUS_ROUTE, WELCOME_ROUTE } from "../paths";
...
const DeleteKeyring = (): JSX.Element => {
  ...
  const onDelete = async (): Promise<void> => {
    try {
      ...
      toast.show("An error has occurred during deleting keyring", ToastVariant.ERROR);
      console.error(error);
      return;
    }
  ...
  return (
    <NeumaPageLayout id={DELETE_KEYRING_ROUTE} primaryTitle="Delete" title="Keyring" onBack={onBack}>
