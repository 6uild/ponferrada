...
import deleteKeyringIcon from "./assets/deleteKeyring.svg";
...
const AccountView = (): JSX.Element => {
  ...
  const items = [
    ...
    {
      icon: deleteKeyringIcon,
      text: "Delete Keyring",
      action: () => history.push(DELETE_KEYRING_ROUTE),
    },
  ];
  ...
  return (
    <Drawer items={items} footer={footer}>
      <NeumaPageLayout
        id={KEYRING_STATUS_ROUTE}
        primaryTitle="Keyring"
        title="Status"
