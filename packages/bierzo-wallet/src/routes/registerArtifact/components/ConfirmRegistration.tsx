...
const ConfirmRegistration = ({ transactionId, onSeeTransactions, onReturnToBalance }: Props): JSX.Element => {
  ...
  return (
    ...
    >
      <Typography color="textPrimary" variant="subtitle1" weight="semibold" align="center">
        Your add artifact request was successfully signed and sent to the network.
      </Typography>
